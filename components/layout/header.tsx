...
export function Header() {
  ...
  return (
    <header
      className={`header fixed inset-x-0 top-0 z-[100] flex items-center justify-between border-b px-[var(--gutter)] py-[18px] backdrop-blur-[14px] transition-colors duration-300 ${
        scrolled
